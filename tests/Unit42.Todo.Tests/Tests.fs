...
let createHost () =
  WebHostBuilder()
    ...
    .Configure(Action<IApplicationBuilder> Unit42.Todo.App.configureApp)
    .ConfigureServices(
      Action<IServiceCollection> Unit42.Todo.App.configureServices
    )
